...
<head>
  ...
  <title>Data Admin | Sistem Informasi Ekstrakurikuler</title>
</head>
...
<body>
  ...
  <div class="row">
    ...
    <div class="offset-lg-1 col-lg-10 col-md-12 col-sm-12">
      <table class="table table-hover table-bordered table-sm display nowrap table1" id="tabel" cellspacing="0">
        ...
        <tbody>
          <?php
          $sql = mysqli_query($koneksi, "SELECT * FROM user WHERE level = 'admin'");
          ...
          ?>
            <tr>
              ...
              <td style="text-align: center; width: 50px">
                <center>
                  <a href="config/proses.php?hapusDataAdmin=<?php echo $row['id']; ?>" class="btn btn-danger btn-sm" id="hapusData" name="hapusDataAdmin"><i class="fas fa-times"></i></a>
                  <a href="./edit_admin.php?id_admin=<?php echo $row['id']; ?>" class="btn btn-primary btn-sm"><i class="fas fa-pencil-alt"></i></a>
                </center>
              </td>
            </tr>
          <?php
  ...
  <div class="modal fade" id="tambah" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <!--todo form tambah-->
      <form method="post" action="config/proses.php" name="tambahDataAdmin">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="namaAdmin" name="namaAdmin" onkeypress="return hanyaHuruf1(event)" oninvalid="setCustomValidity('Hanya dapat menginput alphabet. ')" autocomplete="off" required>
            </div>
            <div class="form-group">
          ...
          <div class="modal-footer">
            <button type="submit" class="btn btn-primary btn1" name="tambahDataAdmin">Tambah</button>
          </div>
        </div>
      </form>
    </div>
